...
\renewcommand{\code}[1]{\fcolorbox{VerbatimBorderColor}{VerbatimColor}{\ourstrut\texttt{\small\color{VerbatimTextColor}#1}}}
...
\else%
% \typeout{page break}%
{\vspace{-1.5em}\small\hspace{380pt} #1 \par\break\hspace{320pt} #2 \par\nobreak}%
\fi%
\fi%
\expandafter\label\expandafter{\the\bt@count bt@count}%
\nobreak%
