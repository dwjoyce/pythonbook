...
# -*- coding: utf-8 -*-
#
# pythonbook documentation build configuration file, created by
...
try:
    version = subprocess.check_output("git describe --abbrev=0 --tags".split(),
...
if not isrelease:
    latex_elements["releasename"] = "Pre-release"
...
latex_additional_files = ["sphinx.sty", "newfloat.sty", "images/python-logo-bw.pdf", "images/raspberry-pi-logo-bw.pdf", "ext/Makefile"]
...
# Turn todo on (or off)
todo_include_todos = not isrelease
