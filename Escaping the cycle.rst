...
Save it as adder.py, and see what happens.  It should keep printing out the *Help* message.  To stop the program, you need to press the ``Ctl`` and ``C`` keys together - this breaks out of the loop.
